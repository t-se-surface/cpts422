...
Turing_Machine::Turing_Machine(string definition_file_name): description({}), valid(true), initial_state(" "),           
							current_state(" "), original_input_string(" "), number_of_transitions(0),
